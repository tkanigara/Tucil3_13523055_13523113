...
public class TestParser {
    public static void main(String[] args) {
        try {            // First, read the file directly to see what's in it
            System.out.println("Reading file directly:");
            BufferedReader reader = new BufferedReader(new FileReader("test/test2.txt"));
            String line;
            ...
            Board board = parser.parseFile("test/test2.txt");
